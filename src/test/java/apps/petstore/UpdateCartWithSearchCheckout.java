...
public class UpdateCartWithSearchCheckout extends CommonAPI {
    @Test
    public void UpdateCartWithSearchCheckout() {
        ...
        driver.findElement(By.cssSelector("a[href='/actions/Catalog.action?viewProduct=&productId=FL-DLH-02']")).click();
